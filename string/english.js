...
var string = {
	janith: {
		Status: 200,
		Code: 'Janith sadanuwan',
		lang: {
			code: 'EN',
			author: 'Janith sadanuwan Manoj'
		},
		file: 'English',
		Country: 'Sri Lanka',
		...
		alive : {
			...
			msg : 'Start\n{start:alive}\n\nAdd Text Message (keywords: #rate #device #rule)\n'
                   + '{text:*Hi! #user*\n\nI Am #myname\n\nBot Status: Alive\n\n}\n\n'
                   + 'Url Buttons\n'
                   + '{url:GO TO URL|https://github.com/janithsadanuwan}\n'
                   + '{url:SUBSCRIBE YOUTUBE|https://youtube.com/c/janithsadanuwan}\n\n'
                   + 'Buttons\n'
                   + '{button:RATE US|rate}\n'
                   + '{button:NOTES|notes}\n'
